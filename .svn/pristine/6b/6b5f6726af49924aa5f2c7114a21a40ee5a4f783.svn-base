...
Graph PremadeGraphs::createChinaMap(bool isWeighted){
    ...
    string labels[] = {"Beijing", "Chengdu", "Chongqing", "Guangzhou", "Hangzhou",
                       "Hongkong", "Shanghai", "Shenzhen", "Wuhan","Nanjing"};
    ...
    g.insertEdge(vertices[0], vertices[8]);
    g.insertEdge(vertices[0], vertices[9]);
    g.insertEdge(vertices[2], vertices[1]);
    g.insertEdge(vertices[9], vertices[4]);
    g.insertEdge(vertices[4], vertices[3]);
    g.insertEdge(vertices[4], vertices[6]);
    g.insertEdge(vertices[9], vertices[6]);
    g.insertEdge(vertices[3], vertices[7]);
    g.insertEdge(vertices[7], vertices[5]);
    g.insertEdge(vertices[8], vertices[4]);
    g.insertEdge(vertices[8], vertices[2]);
    g.insertEdge(vertices[2], vertices[3]);

    if(isWeighted){
        g.setEdgeWeight(vertices[0], vertices[2], 1756);
        g.setEdgeWeight(vertices[0], vertices[8], 1156);
        g.setEdgeWeight(vertices[0], vertices[9], 1021);
        g.setEdgeWeight(vertices[2], vertices[1], 340);
        g.setEdgeWeight(vertices[9], vertices[4], 276);
        g.setEdgeWeight(vertices[4], vertices[3], 1287);
        g.setEdgeWeight(vertices[4], vertices[6], 176);
        g.setEdgeWeight(vertices[9], vertices[6], 305);
        g.setEdgeWeight(vertices[3], vertices[7], 128);
        g.setEdgeWeight(vertices[7], vertices[5], 50);
        g.setEdgeWeight(vertices[8], vertices[4], 751);
        g.setEdgeWeight(vertices[8], vertices[2], 868);
        g.setEdgeWeight(vertices[2], vertices[3], 1356);
    }
